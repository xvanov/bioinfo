...
structure = Bio.PDB.PDBParser(QUIET=True).get_structure('Hemoglobin','../../dat/mmdb_1A3N.pdb')

# Define a function to build a model of the protein from the coordinates, and calculate the dihedral angles between each amino acid
